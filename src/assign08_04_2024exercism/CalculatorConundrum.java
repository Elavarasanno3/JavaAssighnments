...
class CalculatorConundrum {
    public String calculate(int operand1, int operand2, String operation) {
        ...
        switch (operation) {
            ...
            case "+":
                ...
                break;
            default:
                throw new IllegalOperationException(String.format("Operation '%s' does not exist", operation), ex);
        }
    ...
    static class IllegalOperationException extends Throwable {
        public IllegalOperationException(String s, ArithmeticException ex) {
        }
    }
}
